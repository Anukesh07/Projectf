...
<div class="boxx">
<h1 style="color:#03f4eb ;font-size:100px;margin-bottom:10px ;margin-top:10px ;display:inline ;">  A  </h1>
...
<form  action="questions.php" method="post" enctype="multipart/form-data" autocomplete="off" >
 ...
 <option value="MECH">MECH</option>
    ...
    <br><br>
 <input class="bbuttonn" id="put" type="submit"  value="POST" name="post" />
 <input type="button" class="buttonn" value="Add Teacher" onClick="addRow('dataTable')"/>
 <input type="button"class="buttonn" value="Remove Teacher" onClick="deleteRow('dataTable')" />
